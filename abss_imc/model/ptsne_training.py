...
from ..utils.torch_utils import EPS_max, EPS_like
from ..utils.ptsne_utils import get_random_string, entropy, distance_functions

# from ptsne_config import config

# if torch.cuda.is_available():
#     EPS = tensor([1e-10]).to(device('cuda:0'))
# else:
#     EPS = tensor([1e-10]).to(device('cpu'))
